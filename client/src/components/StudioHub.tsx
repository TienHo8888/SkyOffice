...
import { studioInteractiveObjects, studioRoomName, studioRoomZones } from '../../../types/StudioWorld'
...
export default function StudioHub() {
  ...
  const openCareerPicker = () => {
    const careerCenter = studioInteractiveObjects.find((object) => object.id === 'career-center')
    if (!careerCenter) {
      setError('Không tìm thấy Career Hub.')
      return
    }
    setOpen(false)
    phaserEvents.emit(Event.WORK_INTERACTION, careerCenter)
  }
