...
export default function WorkJobBoard({ snapshot, onStart, busyJobId }: WorkJobBoardProps) {
  ...
  return <div className="work-page">
    ...
    {!currentCareer && <div className="work-onboarding-banner"><span>✦</span><div><strong>Bước 1 · Làm Inbox Triage</strong><p>Đây là tutorial đầu tiên. Hoàn thành xong, hãy đi tới workstation của nghề bạn muốn để chọn nghề; Career Center chỉ xem nghề hiện tại và chứng chỉ.</p></div></div>}
